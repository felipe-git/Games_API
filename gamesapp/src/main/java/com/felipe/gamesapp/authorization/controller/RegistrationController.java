/*
 * com.felipe.gamesapp.authorization.controller.RegistrationController (2 gru
 * 2019)
 * 
...
import com.felipe.gamesapp.authorization.eventsAndListeners.OnRegistrationCompleteEvent;
import com.felipe.gamesapp.authorization.eventsAndListeners.exception.InvalidOldPasswordException;
...
import com.felipe.gamesapp.authorization.web.message.GenericResponse;
import com.felipe.gamesapp.authorization.web.viewModel.PasswordView;
...
public class RegistrationController {
	...
	@ResponseBody
	public GenericResponse registerUserAccount(@Valid final UserView accountDto, final HttpServletRequest request) {
	...
	@ResponseBody
	public GenericResponse savePassword(final Locale locale, @Valid PasswordView passwordView) {
		final User user = (User)SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		userService.changeUserPassword(user, passwordView.getNewPassword());
	...
	@ResponseBody
	public GenericResponse changeUserPassword(final Locale locale, @Valid PasswordView passwordView) {
		final User user = userService.findUserByEmail(
				((User)SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getEmail());
		if(!userService.checkIfValidOldPassword(user, passwordView.getOldPassword())) {
