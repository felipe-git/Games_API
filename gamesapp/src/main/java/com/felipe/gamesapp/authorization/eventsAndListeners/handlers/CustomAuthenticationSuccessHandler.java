/*
 * com.felipe.gamesapp.authorization.eventsAndListeners.handlers.
 * CustomAuthenticationSuccessHandler (2 gru 2019)
 * 
...
import com.felipe.gamesapp.authorization.eventsAndListeners.listeners.LoggedUserListener;
...
//	private DeviceService deviceService;
	...
	public void onAuthenticationSuccess(final HttpServletRequest request, final HttpServletResponse response,
		...
		if(session != null) {
			...
			LoggedUserListener user = new LoggedUserListener(username, activeUserStore);
